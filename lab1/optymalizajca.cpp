...
int main() {
    ...
    for (int approach = 0; approach < 100; approach++) {
        first_id = rand() % 100;
        second_id = rand() % 100;
        double max_dist = 0.0;
        for (int i = 0; i < 100; i++) {
        ...
        cout << first_id << "|" << second_id << "," << d << endl;
    }
    ...
    for (int approach = 0; approach < 100; approach++) {
        ...
        cout << first_id << "|" << second_id << "," << d2 << endl;
    }

    cout << "Regret heuristic" << endl;
    for (int approach = 0; approach < 100; approach++) {
        first_id = rand() % 100;
        second_id = rand() % 100;
        ...
        cout << first_id << "|" << second_id << "," << d3 << endl;
    }
